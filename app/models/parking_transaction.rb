class ParkingTransaction < ApplicationRecord
  ...
  def self.batch
    ...
    # path = '/home/kiburei/Documents/RevenueSure ReconMate Files/clamped.csv'
    # path = '/home/kiburei/Documents/RevenueSure ReconMate Files/offstreet.csv'
    # path = '/home/kiburei/Documents/RevenueSure ReconMate Files/onstreet.csv'
